...
На главной форме приложение находятся 3 кнопки: "Запустить поток", "Разбудить поток" и "Остановить поток".
...
А представьте, что такой поток не единственный, а их 1000 штук! В этом случае большая часть ресурсов процессора будет занята на выполнение описанного выше алгоритма!
